...
from consent_assistant.config import LOCKED_PROFILE, config
from consent_assistant.openai_realtime import OpenaiRealtimeHandler
from consent_assistant.headless_personality_ui import mount_personality_routes
...
class LocalStream:
    ...
    def _persist_personality(self, profile: Optional[str]) -> None:
        ...
        try:
            from consent_assistant.config import set_custom_profile
    ...
    def _init_settings_ui_if_needed(self) -> None:
        ...
        def _ready() -> JSONResponse:
            try:
                mod = sys.modules.get("consent_assistant.tools.core_tools")
