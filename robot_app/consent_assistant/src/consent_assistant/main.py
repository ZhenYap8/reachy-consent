...
from consent_assistant.utils import (
    parse_args,
    setup_logger,
    handle_vision_stuff,
...
def run(
    ...
    from consent_assistant.moves import MovementManager
    from consent_assistant.console import LocalStream
    from consent_assistant.openai_realtime import OpenaiRealtimeHandler
    from consent_assistant.tools.core_tools import ToolDependencies
    from consent_assistant.audio.head_wobbler import HeadWobbler
    ...
    if args.gradio:
        ...
        from consent_assistant.gradio_personality import PersonalityUI
...
class ConsentAssistant(ReachyMiniApp):  # type: ignore[misc]
