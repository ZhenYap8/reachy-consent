...
from consent_assistant.config import config
from consent_assistant.prompts import get_session_voice, get_session_instructions
from consent_assistant.tools.core_tools import (
    ToolDependencies,
    get_tool_specs,
)
from consent_assistant.tools.background_tool_manager import (
    ToolCallRoutine,
    ToolNotification,
...
class OpenaiRealtimeHandler(AsyncStreamHandler):
    ...
    async def apply_personality(self, profile: str | None) -> str:
        ...
        try:
            ...
            from consent_assistant.config import config as _config
